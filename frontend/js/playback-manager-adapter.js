...
var PlaybackManagerAdapter = (function() {
    ...
    function onStateChange(e, state) {
        console.log('[PM-Adapter] State changed', state);
    }
    ...
    function onError(e, error) {
        console.error('[PM-Adapter] Error event:', error);
    ...
    function setAudioStreamIndex(index) {
        ...
        console.log('[PM-Adapter] setAudioStreamIndex:', index);
    ...
    function setSubtitleStreamIndex(index) {
        ...
        console.log('[PM-Adapter] setSubtitleStreamIndex:', index);
